...
/**
 * Table tl_ergebnisdienst_paarungen
 */
$GLOBALS['TL_DCA']['tl_ergebnisdienst_paarungen'] = array
(
	...
	(
		'dataContainer'               => 'Table',
		'ptable'                      => 'tl_ergebnisdienst_staffeln',
		'switchToEdit'                => true,
	...
	(
		...
		(
			...
			'child_record_callback'   => array('tl_ergebnisdienst_paarungen', 'listPairings'), 
		),
		'label' => array
		(
			'fields'                  => array('pairing', 'homeTeam', 'guestTeam'),
			'group_callback'          => array('tl_ergebnisdienst_paarungen', 'groupFormat')
		),  
		...
		(
			'edit' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_ergebnisdienst_paarungen']['edit'],
				'href'                => 'act=edit',
				'icon'                => 'edit.gif'
			),
			'copy' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_ergebnisdienst_paarungen']['copy'],
				'href'                => 'act=paste&amp;mode=copy',
				'icon'                => 'copy.gif'
			),
			'cut' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_ergebnisdienst_paarungen']['cut'],
				'href'                => 'act=paste&amp;mode=cut',
				'icon'                => 'cut.gif'
			),
			'delete' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_ergebnisdienst_paarungen']['delete'],
				'href'                => 'act=delete',
				'icon'                => 'delete.gif',
			...
			'toggle' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_ergebnisdienst_paarungen']['toggle'],
				'icon'                => 'visible.gif',
				'attributes'          => 'onclick="Backend.getScrollOffset();return AjaxRequest.toggleVisibility(this,%s)"',
			),
			'show' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_ergebnisdienst_paarungen']['show'],
				'href'                => 'act=show',
				'icon'                => 'show.gif'
			)
		)
	...
	(
		...
		'homeTeam' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_ergebnisdienst_paarungen']['homeTeam'],
			'exclude'                 => true,
			'inputType'               => 'select',
			'options_callback'        => array('tl_ergebnisdienst_paarungen', 'getTeam'),
			'eval'                    => array
			(
				'mandatory'           => true,
				'chosen'              => true,
		...
		'guestTeam' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_ergebnisdienst_paarungen']['guestTeam'],
			'exclude'                 => true,
			'inputType'               => 'select',
			'options_callback'        => array('tl_ergebnisdienst_paarungen', 'getTeam'),
			'eval'                    => array
		...
		(
			'exclude'                 => true,
			'input_field_callback'    => array('tl_ergebnisdienst_paarungen', 'getResultbox')
		),  
		'referee_result' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_ergebnisdienst_paarungen']['referee_result'],
			'exclude'                 => true,
			'search'                  => false,
			'sorting'                 => false,
			'inputType'               => 'text',
		...
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_ergebnisdienst_paarungen']['referee_comment'],
			'exclude'                 => true,
			'search'                  => false,
			'sorting'                 => false,
			'inputType'               => 'text',
		...
		'round' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_ergebnisdienst_paarungen']['round'],
			'exclude'                 => true,
			'inputType'               => 'text',
			'eval'                    => array
			(
		...
		'pairing' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_ergebnisdienst_paarungen']['pairing'],
			'exclude'                 => true,
			'inputType'               => 'text',
			'eval'                    => array
			(
		...
		'eventDate' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_ergebnisdienst_paarungen']['eventDate'],
			'exclude'                 => true,
			'search'                  => true,
			'inputType'               => 'text',
			'eval'                    => array
			...
			'load_callback'           => array
			(
				array('tl_ergebnisdienst_paarungen', 'getDate')
			),
			'save_callback' => array
			(
				array('tl_ergebnisdienst_paarungen', 'putDate')
			),
			'sql'                     => "int(8) unsigned NOT NULL default '0'"
		), 
		'eventTime' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_ergebnisdienst_paarungen']['eventTime'],
			'exclude'                 => true,
			'filter'                  => true,
			'sorting'                 => true,
			'flag'                    => 8,
		...
		'place' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_ergebnisdienst_paarungen']['place'],
			'exclude'                 => true,
			'search'                  => true,
			'sorting'                 => true,
			'flag'                    => 1,
		...
		'address' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_ergebnisdienst_paarungen']['address'],
			'exclude'                 => true,
			'search'                  => true,
			'sorting'                 => true,
			'flag'                    => 1,
		...
		'referee' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_ergebnisdienst_paarungen']['referee'],
			'exclude'                 => true,
			'search'                  => true,
			'sorting'                 => true,
			'flag'                    => 1,
		...
		'comment' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_ergebnisdienst_paarungen']['comment'],
			'exclude'                 => true,
			'search'                  => true,
			'inputType'               => 'textarea',
		...
		'published' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_ergebnisdienst_paarungen']['published'],
			'exclude'                 => true,
			'filter'                  => true,
			'flag'                    => 1,
			'default'                 => 1,
...
/**
 * Class tl_ergebnisdienst_paarungen
 *
 ...
 * @package    News
 */
class tl_ergebnisdienst_paarungen extends Backend
{
	...
	public function __construct()
	{
		...
		$objTeam = $this->Database->prepare("SELECT id, title FROM tl_ergebnisdienst_mannschaften WHERE pid=? ORDER BY sorting ASC")
								  ->execute($_GET['id']);
		while ($objTeam->next())
		{
			$this->nummer++;
	...
	public function getTeam(DataContainer $dc)
	{
		...
		$objSpieler = $this->Database->prepare("SELECT id, sorting, surname, prename FROM tl_ergebnisdienst_spieler WHERE pid=? ORDER BY sorting ASC")
		...
		$stammbretter = 8;
		$objBretter = $this->Database->prepare("SELECT boards FROM tl_ergebnisdienst_staffeln WHERE id=?")
						   ->limit(1)
						   ->execute($dc->activeRecord->pid);
		if($objBretter->boards) $bretter = $objBretter->boards; 
		else $bretter = $stammbretter;
		$GLOBALS['TL_DCA']['tl_ergebnisdienst_paarungen']['fields']['boardresults']['eval']['minCount'] = $bretter;
		$GLOBALS['TL_DCA']['tl_ergebnisdienst_paarungen']['fields']['boardresults']['eval']['maxCount'] = $bretter;

		// Mannschaften laden
		$arrForms = array();
		$objForms = $this->Database->prepare("SELECT id, title FROM tl_ergebnisdienst_mannschaften WHERE pid=? ORDER BY sorting ASC")
						 ->execute($dc->activeRecord->pid);
	...
	public function getResultbox(DataContainer $dc)
	{
		...
		$string = '
<div class="w50 clr">
  <h3><label>' . $GLOBALS['TL_LANG']['tl_ergebnisdienst_paarungen']['resultbox'] . ': ' . $anzeige . '</label></h3>
</div>'; 
